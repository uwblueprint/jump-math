...
type QuestionEditorContextType = {
  ...
  showPreviewQuestionModal: boolean;
  setShowPreviewQuestionModal: (_showPreviewModal: boolean) => void;
};
...
const QuestionEditorContext = createContext<QuestionEditorContextType>({
  ...
  setShowEditorError: (_showEditorError: boolean): void => {},
  showPreviewQuestionModal: false,
  setShowPreviewQuestionModal: (_showPreviewQuestionModal: boolean): void => {},
});
